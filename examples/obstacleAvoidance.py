...
class World(DirectObject):
    ...
    def loadModels(self):
        ...
        self.pursuer.reparentTo(base.render)
        self.pursuer.setScale(0.5)
        self.pursuer.setPos(-10, 0, 0)
        # Target
        ...
        # Obstacle 1
        self.obstacle1 = base.loader.loadModel("models/arrow")
        self.obstacle1.setColor(0, 0, 1)
        self.obstacle1.setPos(2, 0, 0)
        self.obstacle1.setScale(1)
        self.obstacle1.reparentTo(base.render)
        # Obstacle 2
        self.obstacle2 = base.loader.loadModel("models/arrow")
        self.obstacle2.setColor(0, 0, 1)
        self.obstacle2.setPos(5, 5, 0)
        self.obstacle2.setScale(1)
        self.obstacle2.reparentTo(base.render)
